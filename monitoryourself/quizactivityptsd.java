...
public class quizactivityptsd extends MainActivity {

    public questionareptsd mquestionare = new questionareptsd();
    ...
    private void updatequestion()
    {
        ...
        else if(mqno>=7)
        {
                ...
                Intent intent=new Intent(quizactivityptsd.this,resultptsd.class);
